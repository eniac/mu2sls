...
def main(store_conf="local", docker_io_username='default'):
    ...
    if(store_conf in ["local", "beldi"]):
        ...
        deployment_list = [('castinfo', 'cast_info'),
                           ('composereview', 'compose_review'),
                           ('frontend', 'frontend'),
                           ('movieid', 'movie_id'),
        ...
        service_list = ["CastInfo", "ComposeReview", "Frontend", 
                        "MovieId", "MovieInfo", "MovieReview", 
                        "Page", "Plot", "Rating", 
                        "ReviewStorage", "Text", "UniqueId", 
                        "User", "UserReview"]
